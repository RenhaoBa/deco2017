function Calendar() {
	...
	function eventAddClick() {
		...
		var routine = document.getElementsByName("routine");
		for(var index=0; index<routine.length; index++) {

             
			if(routine[index].checked) {
				console.log(routine[index].value);

				if(routine[index].value == 0) {
